...
--
-- Host: localhost:3306
-- Tempo de geração: 09/08/2018 às 15:37
...
(86, 'general', 'logo', 'INT', 'single_file', 'MANYTOONE', 'directus_files', NULL, NULL, 'logo', 0, 0, 4, '', NULL);
...
INSERT INTO `general` (`id`, `main_title`, `main_image`, `email_address`, `logo`) VALUES
(1, 'Pedro Torchio', 4, 'pedro@torchiodev.com', 12);
